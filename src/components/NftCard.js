import { Card, List, Skeleton, Image, Space } from "antd";
...
const NftCard = ({ nft }) => {
  ...
  // https://ipfs.github.io/public-gateway-checker/ ?:optional chaining operator - ensure the image string is valid and not null or undefined
